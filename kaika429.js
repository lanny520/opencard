...
[task_local]
#4.18~5.5 甄选大牌 品质嗨购
12 12 12 12 * https://raw.githubusercontent.com/smiek2121/scripts/master/gua_opencard134.js, tag=4.18~5.5 甄选大牌 品质嗨购, enabled=true
    ...
    if(!$.addCart && !$.outFlag){
      if(guaopencard_addSku+"" == "true"){
        ...
        if(cleanCart){
          ...
          if(goodsArr !== false) await $.wait(parseInt(Math.random() * 1000 + 1000, 10))
        }
